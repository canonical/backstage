import{r as k,j as a,m as X,k as Y,T as Z,a0 as q}from"./iframe-DEJbD2oy.js";import{s as ee,M as ne}from"./api-DgebkQIS.js";import{l as ae}from"./lodash-CwBbdt2Q.js";import{a as te}from"./useAsync-nf_MJHBK.js";import{u as re}from"./useDebounce-DZJNJWOG.js";import{u as _,S as se}from"./SearchContext-Wu2wzbBF.js";import{A as le}from"./Autocomplete-DamLNutC.js";import{C as ie}from"./Chip-ic_VqdlJ.js";import{T as ue}from"./TextField-CEpFJXMo.js";import{s as oe}from"./translation-CDznkhDL.js";import{a as G,F as ce}from"./FormLabel-LuBhA8t-.js";import{F as me}from"./FormControlLabel-CoJtZsE1.js";import{C as de}from"./Checkbox-BVCvLdrh.js";import{S as pe}from"./Select-DckneBKo.js";import{S as B}from"./Grid-DO7F6b3H.js";import"./preload-helper-D9Z9MdNV.js";import"./useMountedState-bnMhxuuW.js";import"./useAnalytics-D3GACT4p.js";import"./Popper-BMjLlwdF.js";import"./Portal-BNcbVIFw.js";import"./ListSubheader-CUz0Cs8H.js";import"./Select-CeV6ppDX.js";import"./index-DnL3XN75.js";import"./Popover-IJb73_9I.js";import"./Modal-DbsR11Ts.js";import"./List-DKGVLh3A.js";import"./ListContext-XM-uFlGW.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-Bsm2g822.js";import"./InputLabel-BPeGcJgf.js";import"./SwitchBase-DIL4QKya.js";import"./Cancel-DPzqeszg.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-CEQYom6P.js";import"./styled-C1nvoQOK.js";import"./MenuItem-fQtqrmwg.js";import"./ListItem-D0VRuO7C.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function ge(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let R;const ve=new Uint8Array(16);function fe(){if(!R){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");R=crypto.getRandomValues.bind(crypto)}return R(ve)}const ye=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),z={randomUUID:ye};function be(e,n,l){if(z.randomUUID&&!e)return z.randomUUID();e=e||{};const t=e.random??e.rng?.()??fe();if(t.length<16)throw new Error("Random bytes length must be >= 16");return t[6]=t[6]&15|64,t[8]=t[8]&63|128,ge(t)}function F(e){if(e!==void 0)return Array.isArray(e)?e.map(n=>F(n)):typeof e=="string"?{value:e,label:e}:e}const L=(e,n,l=[],t=250)=>{const r=k.useRef({}),u=k.useCallback(async o=>(await e?.(o))?.map(b=>F(b))||[],[e]),[y,d]=te(u,[n],{loading:!0});if(re(()=>{r.current[n]===void 0&&(r.current[n]=d(n).then(o=>(r.current[n]=o,o)))},t,[d,n]),l.length)return{loading:!1,value:l};const v=r.current[n];return Array.isArray(v)?{loading:!1,value:v}:y},O=(e,n)=>{const{setFilters:l}=_();k.useEffect(()=>{n&&[n].flat().length>0&&l(t=>({...t,[e]:n}))},[])},H=e=>{const{className:n,defaultValue:l,name:t,values:r,valuesDebounceMs:u,label:y,filterSelectedOptions:d,limitTags:v,multiple:o}=e,[b,V]=k.useState("");O(t,l);const h=typeof r=="function"?r:void 0,S=typeof r=="function"?void 0:r?.map(m=>F(m)),{value:A,loading:c}=L(h,b,S,u),{filters:p,setFilters:D}=_(),g=F(p[t]),x=k.useMemo(()=>g||(o?[]:null),[g,o]),j=(m,f)=>{D(W=>{const{[t]:U,...$}=W;return f?{...$,[t]:Array.isArray(f)?f.map(Q=>Q.value):f.value}:{...$}})},w=m=>a.jsx(ue,{...m,name:"search",variant:"outlined",label:y,fullWidth:!0}),N=(m,f)=>m.map((W,U)=>a.jsx(ie,{label:W.label,color:"primary",...f({index:U})}));return a.jsx(le,{filterSelectedOptions:d,limitTags:v,multiple:o,className:n,id:`${o?"multi-":""}select-filter-${t}--select`,options:A||[],loading:c,value:x,onChange:j,onInputChange:(m,f)=>V(f),getOptionLabel:m=>m.label,renderInput:w,renderTags:N})};H.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"FilterValue[] | ((partial: string) => Promise<FilterValue[]>)",elements:[{name:"Array",elements:[{name:"union",raw:"string | FilterValueWithLabel",elements:[{name:"string"},{name:"signature",type:"object",raw:"{ value: string; label: string }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}}]}}]}],raw:"FilterValue[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
