import{m as p,j as r}from"./iframe-DEJbD2oy.js";import{G as v}from"./Gauge-fsSQb0ZB.js";import{B as y}from"./Box-CEQYom6P.js";import{I as b}from"./InfoCard-DpFXWLt7.js";const q=p({root:{height:"100%",width:250},rootSmall:{height:"100%",width:160}},{name:"BackstageGaugeCard"});function f(n){const t=q(n),{title:i,subheader:a,progress:u,inverse:s,deepLink:o,description:g,icon:l,variant:d,alignGauge:m="normal",size:e="normal",getColor:c}=n,k={inverse:s,description:g,getColor:c,value:u};return r.jsx(y,{className:e==="small"?t.rootSmall:t.root,children:r.jsx(b,{title:i,subheader:a,deepLink:o,variant:d,alignContent:m,icon:l,titleTypographyProps:{...e==="small"?{variant:"subtitle2"}:void 0},subheaderTypographyProps:{...e==="small"?{variant:"body2"}:void 0},children:r.jsx(v,{...k,size:e})})})}f.__docgenInfo={description:`{@link Gauge} with header, subheader and footer
