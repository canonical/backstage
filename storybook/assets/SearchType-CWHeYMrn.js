import{r as p,ag as F,ah as M,ai as P,aj as z,s as J,m as T,n as W,k as q,j as r,d as X}from"./iframe-DEJbD2oy.js";import{E as O}from"./ExpandMore-C2FNbPlx.js";import{u as B}from"./useAsync-nf_MJHBK.js";import{s as j}from"./translation-DRv4HF7P.js";import{u as A}from"./SearchContext-Wu2wzbBF.js";import{s as H}from"./api-DgebkQIS.js";import{B as U}from"./Box-CEQYom6P.js";import{A as $,a as G,b as K}from"./AccordionDetails-B2fj-Vyu.js";import{L as Q}from"./List-DKGVLh3A.js";import{D as Y}from"./Divider-D1VqbXY-.js";import{L as Z}from"./ListItem-D0VRuO7C.js";import{L as ee}from"./ListItemIcon-UaSCtvmP.js";import{L as I}from"./ListItemText-C-jh_lXe.js";import{T as re,a as ae}from"./Tabs-D3pNHVGt.js";import{a as se}from"./FormLabel-LuBhA8t-.js";import{I as ne}from"./InputLabel-BPeGcJgf.js";import{S as te}from"./Select-CeV6ppDX.js";import{M as ie}from"./MenuItem-fQtqrmwg.js";import{C as oe}from"./Checkbox-BVCvLdrh.js";import{C as le}from"./Chip-ic_VqdlJ.js";var ce=function(e){p.useEffect(e,[])},h={},C;function ue(){if(C)return h;C=1;var e=F(),n=M();Object.defineProperty(h,"__esModule",{value:!0}),h.default=void 0;var t=n(P()),u=e(z()),l=(0,u.default)(t.createElement("path",{d:"M9.93 13.5h4.14L12 7.98zM20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-4.05 16.5l-1.14-3H9.17l-1.12 3H5.96l5.11-13h1.86l5.11 13h-2.09z"}),"FontDownload");return h.default=l,h}var pe=ue();const me=J(pe),de=T(e=>({icon:{color:e.palette.text.primary},list:{width:"100%"},listItemIcon:{width:"24px",height:"24px"},accordion:{backgroundColor:e.palette.background.paper},accordionSummary:{minHeight:"auto","&.Mui-expanded":{minHeight:"auto"}},accordionSummaryContent:{margin:e.spacing(2,0),"&.Mui-expanded":{margin:e.spacing(2,0)}},accordionDetails:{padding:e.spacing(0,0,1)}})),E=e=>{const n=de(),{filters:t,setPageCursor:u,setTypes:l,term:c,types:i}=A(),m=W(H),[y,f]=p.useState(!0),{defaultValue:s,name:o,showCounts:w,types:N}=e,{t:v}=q(j),g=p.useRef(null),D=()=>f(a=>!a),V=a=>()=>{l(a!==""?[a]:[]),u(void 0)};p.useEffect(()=>{s&&l([s])},[]);const b=[{value:"",name:v("searchType.accordion.allTitle"),icon:r.jsx(me,{})},...N],_=i[0]||"",{value:k}=B(async()=>{if(!w)return{};g.current&&g.current.abort();const a=new AbortController;g.current=a;const L=await Promise.all(b.map(d=>d.value).map(async d=>{const{numberOfResults:x}=await m.query({term:c,types:d?[d]:[],filters:i.includes(d)||!i.length&&!d?t:{},pageLimit:0},{signal:a.signal});return[d,x!==void 0?v("searchType.accordion.numberOfResults",{number:x>=1e4?">10000":`${x}`}):" -- "]}));return Object.fromEntries(L)},[t,w,c,i]);return p.useEffect(()=>()=>{g.current&&g.current.abort()},[]),r.jsxs(U,{children:[r.jsx(X,{variant:"body2",component:"h2",children:o}),r.jsxs($,{className:n.accordion,expanded:y,onChange:D,children:[r.jsx(G,{classes:{root:n.accordionSummary,content:n.accordionSummaryContent},expandIcon:r.jsx(O,{className:n.icon}),IconButtonProps:{size:"small"},children:y?v("searchType.accordion.collapse"):b.filter(a=>a.value===_)[0].name}),r.jsx(K,{classes:{root:n.accordionDetails},children:r.jsx(Q,{className:n.list,component:"nav","aria-label":"filter by type",disablePadding:!0,dense:!0,children:b.map(a=>r.jsxs(p.Fragment,{children:[r.jsx(Y,{}),r.jsxs(Z,{selected:i[0]===a.value||i.length===0&&a.value==="",onClick:V(a.value),button:!0,children:[r.jsx(ee,{children:p.cloneElement(a.icon,{className:n.listItemIcon})}),r.jsx(I,{primary:a.name,secondary:k&&k[a.value]})]})]},a.value))})})]})]})};E.__docgenInfo={description:"",methods:[],displayName:"SearchTypeAccordion",props:{name:{required:!0,tsType:{name:"string"},description:""},types:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  value: string;
  name: string;
  icon: JSX.Element;
